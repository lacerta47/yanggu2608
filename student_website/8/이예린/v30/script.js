// -------------------------------------------------------------
// 3D 1인칭 용사의 모험 RPG v30 Engine
// (둥실둥실 몽실 뭉게구름 & 대산맥 등산 시스템)
// -------------------------------------------------------------
...
const npcsVillage = [
    { 
        ...
        color: 0xf39c12, 
        hatColor: 0xd35400,
        story: "허허, 어서오게 젊은 용사여!\n하늘 위로 둥실둥실 떠다니는 솜사탕 뭉게구름이 보이는가?\n대산맥 꼭대기에 올라 구름 속을 산책하고 숲 전체를 내려다보게나!",
        chatLines: ["허허, 뭉게구름이 둥실둥실 흘러가는구려~", "주희 양, 구름이 솜사탕 같구려!", "민우야, 구름 보며 산책하렴!", "철수 자네 망치 소리가 구름까지 울리는군!"],
    ...
    { 
        ...
        color: 0x2ecc71, 
        hatColor: 0x27ae60,
        story: "안녕하세요 용사님! 구름이 산봉우리를 스칠 때 내리는 이슬을 머금은 약초가 자라요!\n300코인으로 칼을 단련해서 몽실 구름 가득한 산맥으로 떠나보세요!",
    ...
    { 
        ...
        color: 0xff7675, 
        hatColor: 0xd63031,
        story: "와! 하늘에 몽실몽실 뭉게구름이 떠다녀요!\n형, 산꼭대기에 올라가면 구름을 손으로 만질 수 있을 것 같아요!",
    ...
    { 
        ...
        color: 0x3498db, 
        hatColor: 0x2980b9,
        story: "반갑네 젊은 용사여! 구름을 뚫고 대산맥 꼭대기에 오르는 것이야말로 모험의 백미지!\n대장장이 철수에게서 칼을 벼리고 구름 위 정상으로 발걸음을 옮겨보게나!",
...
// -------------------------------------------------------------
// 3D 1인칭 메인 애니메이션 & 뭉게구름 유기적 이동 루프
// -------------------------------------------------------------
function animate() {
