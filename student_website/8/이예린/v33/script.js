// -------------------------------------------------------------
// 3D 1인칭 용사의 모험 RPG v33 Engine
// (마을 대확장 & 8채의 3D 집들과 11명의 활기찬 주민 시스템)
// -------------------------------------------------------------
...
// ⛲ 중앙 광장 분수대 (Village Plaza Fountain)
...
const gateTag = createTagSprite('🌲 [Space] 50마리 몬스터 숲 입장', '#2ed573');
...
const npcsVillage = [
    { 
        ...
        color: 0xf39c12, 
        hatColor: 0xd35400,
        story: "허허, 어서오게 젊은 용사여!\n우리 마을이 8채의 집과 분수대 광장으로 아주 넓고 아름다워졌다네!\n11명의 이웃들과 인사도 나누고, 50마리 몬스터 숲으로 모험을 떠나보게나!",
        chatLines: ["허허, 우리 마을 분수대가 참 시원하구려~", "미나 양, 오늘 빵 냄새가 향긋하네!", "준혁 대장, 마을 경비에 힘써주게!", "용사여, 체력이 다 닳지 않게 조심하게!"],
    ...
    { 
        ...
        color: 0x2ecc71, 
        hatColor: 0x27ae60,
        story: "안녕하세요 용사님! 넓어진 마을 화단에서 싱싱한 약초를 가꾸고 있어요!\n300코인으로 칼을 단련해서 50마리 아기 몬스터 대군단과 모험을 떠나보세요!",
    ...
    { 
        ...
        color: 0xff7675, 
        hatColor: 0xd63031,
        story: "와! 넓어진 마을 광장에서 술래잡기하니까 너무 신나요!\n형, 체력 다 닳으면 결과창 나오니까 조심해서 놀아줘요!",
    ...
    { 
        ...
        color: 0x9b59b6, 
        hatColor: 0x8e44ad,
        story: "안녕하세요! 예쁜 꽃집 앞에서 튤립과 장미를 심고 있어요.\n강화된 반짝이는 칼로 50마리 몬스터 친구들과 사랑스러운 추억을 만들어보세요!",
    ...
    { 
        ...
        color: 0x3498db, 
        hatColor: 0x2980b9,
        story: "반갑네 젊은 용사여! 대확장된 마을을 기점으로 50마리 군단을 마주해보게나!\n대장장이 철수에게서 칼을 단련하고 구름 위 대산맥과 슬라임 숲을 정복해보게나!",
        chatLines: ["넓어진 마을의 정취가 참 멋지군!", "현우 학자, 고대 전설을 찾았는가?", "대장장이 철수 칼솜씨는 여전히 최고야."],
    ...
    { 
        ...
        color: 0xe67e22, 
        hatColor: 0xd35400,
        story: "따끈따끈한 크루아상과 바게트가 막 구워졌어요 용사님!\n달콤한 빵 냄새 가득한 마을에서 힘을 얻고 몬스터 친구들을 만나러 가보세요!",
    ...
    { 
        ...
        color: 0x6c5ce7, 
        hatColor: 0x4834d4,
        story: "반갑습니다 용사님. 고대 기록에 따르면 대산맥 꼭대기에는 신비로운 구름 파노라마가 펼쳐진다고 해요.\n충분한 레벨과 단련된 칼로 구름 정상을 밟아보세요!",
        chatLines: ["마을의 고대 지도를 해독 중입니다.", "한스 씨, 모험 이야기 더 들려주세요.", "도서관에 흥미로운 전설책이 많아요."],
    ...
    { 
        ...
        color: 0xfd79a8, 
        hatColor: 0xe84393,
        story: "하늘에 떠다니는 24개의 몽실 뭉게구름과 8채의 예쁜 집들을 캔버스에 담고 있어요!\n용사님의 멋진 모험 모습도 그림으로 그려드릴게요!",
        chatLines: ["오늘 하늘의 구름 색깔이 최고예요!", "영희 언니 꽃집이 화폭에 쏙 들어와요.", "초록 슬라임들의 점프를 스케치했어요!"],
    ...
    { 
        ...
        color: 0x636e72, 
        hatColor: 0x2d3436,
        story: "충성! 마을 동쪽 숲 게이트를 굳건히 지키는 경비대장 준혁입니다!\n마을 주민들의 안전은 제가 지킬 테니, 용사님께선 숲속 50마리 몬스터를 자유롭게 평정하십시오!",
        chatLines: ["마을 성문 경계 이상 무!", "이장님, 오늘도 평화로운 마을입니다!", "용사여, 마을의 수호자가 되어주시오!"],
...
// -------------------------------------------------------------
// 👾 총 50마리 몬스터 대군단 (일반 슬라임 20마리 + 귀여운 아기 몬스터 30마리)
// -------------------------------------------------------------
const monsters3D = [
    // 1~6: 서쪽 숲 & 서쪽 초록 언덕
    ...
    // 🟢 31~50: 숲속 평원과 연못, 산기슭에 배치된 20마리 일반 슬라임들!
    ...
    { id: 'n_slime12', baseName: '🍮 서쪽언덕 일반 슬라임', originX: -40, originZ: -20, patrolRadius: 8, chaseSpeed: 0.06, patrolSpeed: 0.028, color: 0x26de81, baseHp: 50, baseDmg: 5, type: 'slime', scale: 0.8 },
...
function updateUI() {
    ...
    if (currentMap === 'VILLAGE') {
        ...
        locationNameSpan.textContent = '🍮 3D 50마리 슬라임 숲';
    }
}
...
function animate() {
    ...
    if (gameState === 'PLAYING') {
            ...
            for (let i = 0; i < npcsVillage.length; i++) {
                ...
                if (!npc.isTalkingWithNpc) {
                    for (let j = i + 1; j < npcsVillage.length; j++) {
                        ...
                        if (distBetween < 4.5 && !other.isTalkingWithNpc) {
        ...
        // 🌲 50마리 숲속 아기 몬스터 & 일반 슬라임 실시간 피격 & 체력 0 즉각 사망 판정
        if (currentMap === 'FOREST') {
            let hpChanged = false;
