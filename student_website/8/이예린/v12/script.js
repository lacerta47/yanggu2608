// -------------------------------------------------------------
// 3D 1인칭 용사의 모험 RPG v12 Engine (몬스터 코인 & 50% 대장간 칼 강화)
// -------------------------------------------------------------
...
// 🔨 칼 강화 상태 변수
let forgeAttempts = 0; // 시도 횟수 (도전할 때마다 +10원씩 상승)
...
// -------------------------------------------------------------
// ⚒️ 3D 대장간 건물 내부 맵 (Map 2: 대장장이 칼 강화 시스템!)
// -------------------------------------------------------------
...
// 🔨 대장간 50% 확률 칼 강화 로직 (성공 시 데미지 +5, 시도당 +10원 상승!)
btnForgeWeapon.addEventListener('click', () => {
    ...
    forgeAttempts++; // 시도 횟수 증가 ➔ 다음 도전 비용 +10원 상승!

    if (isSuccess) {
        swordDamage += 5; // 공격력 +5 상승!
