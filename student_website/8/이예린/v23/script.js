// -------------------------------------------------------------
// 3D 1인칭 용사의 모험 RPG v23 Engine
// (시작 코인 300코인 지급 & 언제 어디서나 시원한 칼 강화 시스템)
// -------------------------------------------------------------
...
const npcsVillage = [
    { 
        ...
        color: 0xf39c12, 
        hatColor: 0xd35400,
        story: "허허, 어서오게 젊은 용사여!\n마을에서 지원해 준 300코인으로 대장장이 철수에게 가서 칼을 바로 강화해보게나!\n칼이 튼튼해지면 숲속 몬스터들도 손쉽게 무찌를 수 있을 걸세!",
    ...
    { 
        ...
        color: 0x2ecc71, 
        hatColor: 0x27ae60,
        story: "안녕하세요 용사님! 전 아픈 이웃들을 돌보는 약초꾼 주희예요.\n용사님께서 300코인으로 칼을 단련해서 숲속 슬라임들을 혼내주시면 감사하겠어요!",
    ...
    { 
        ...
        color: 0xe74c3c, 
        hatColor: 0xc0392b,
        story: "와! 칼을 든 멋진 용사 형이다!\n형 칼에서 황금빛이 나요! 대장간에서 칼을 더 멋지게 강화해 보세요!",
    ...
    { 
        ...
        color: 0x3498db, 
        hatColor: 0x2980b9,
        story: "반갑네 젊은 용사여! 대장장이 철수의 강화 확률이 75%로 대폭 올랐다네!\n어서 300코인으로 칼을 강력하게 벼려보게나!",
...
const blacksmithNpc = {
    ...
    z: -3.5,
    color: 0xe67e22,
    story: "뜨거운 불꽃이 타오르는 대장간에 잘 왔네 용사여!\n시작 지원금으로 받은 300코인으로 칼을 바로 단련해보게나!\n첫 강화 비용은 30코인이며, 성공 확률이 75%로 아주 높아서 칼 공격력이 쑥쑥 오를 걸세!",
...
function createForestMushroom(x, z, capColor = 0xe74c3c) {
    ...
    const stem = new THREE.Mesh(new THREE.CylinderGeometry(0.1, 0.12, 0.4, 8), new THREE.MeshStandardMaterial({ color: 0xffffff }));
    stem.position.y = 0.2;
    shroom.add(stem);

    const cap = new THREE.Mesh(new THREE.ConeGeometry(0.38, 0.32, 10), new THREE.MeshStandardMaterial({ color: capColor }));
    cap.position.y = 0.45;
    shroom.add(cap);
...
// ⚒️ 칼 강화 버튼 클릭 액션 (성공 확률 75% 대폭 상향!)
