// -------------------------------------------------------------
// 3D 1인칭 용사의 모험 RPG v32 Engine
// (일반 슬라임 대량 추가 & 50마리 아기 몬스터 대군단 시스템)
// -------------------------------------------------------------
...
const npcsVillage = [
    { 
        ...
        color: 0xf39c12, 
        hatColor: 0xd35400,
        story: "허허, 어서오게 젊은 용사여!\n초록빛 일반 슬라임들이 대거 합류하여 몬스터가 무려 50마리나 뛰놀고 있다네!\n체력이 0이 되지 않도록 조심하며 50마리 친구들과 신나게 놀아보게나!",
        chatLines: ["허허, 50마리 몬스터들이 참 활기차구려~", "주희 양, 일반 슬라임들이 통통 튀네!", "민우야, 체력 다 닳지 않게 조심하렴!", "철수 자네 칼 솜씨로 50마리를 수호해주게!"],
    ...
    { 
        ...
        color: 0x2ecc71, 
        hatColor: 0x27ae60,
        story: "안녕하세요 용사님! 일반 슬라임들이 연두색 풀밭 위에서 통통 튀며 놀고 있어요!\n300코인으로 칼을 단련해서 50마리 아기 몬스터 대군단과 모험을 떠나보세요!",
        chatLines: ["일반 슬라임들이 정말 귀여워요!", "이장님, 슬라임이 50마리나 있어요~", "영희 씨, 연못가에도 슬라임이 가득해요!"],
    ...
    { 
        ...
        color: 0xff7675, 
        hatColor: 0xd63031,
        story: "와! 초록색 일반 슬라임들이랑 50마리 몬스터 친구들이 다 모였어요!\n형, 체력 다 닳으면 결과창 나오니까 조심해서 놀아줘요!",
        chatLines: ["50마리랑 다 숨바꼭질할 거예요!", "한스 아저씨, 슬라임 만져봤어요?", "와아~ 슬라임이 통통 점프해요!"],
        quest: { title: "숲속 탐험", desc: "50마리 몬스터 숲과 산꼭대기를 탐험하기", targetType: "explore", rewardExp: 30, active: false, completed: false } 
    },
    { 
        id: 'villager4', 
        name: '정원사 영희', 
        ...
        color: 0x9b59b6, 
        hatColor: 0x8e44ad,
        story: "안녕하세요! 일반 슬라임들이 정원의 잔디를 초록빛으로 빛내주고 있어요.\n강화된 반짝이는 칼로 50마리 몬스터 친구들과 사랑스러운 추억을 만들어보세요!",
        chatLines: ["슬라임들이 꽃밭을 좋아해요~", "주희 씨, 슬라임 볼터치가 핑크빛이에요!", "숲속이 50마리 친구들로 북적여요~"],
    ...
    { 
        ...
        color: 0x3498db, 
        hatColor: 0x2980b9,
        story: "반갑네 젊은 용사여! 50마리로 불어난 대군단과 함께하는 모험은 정말 장관이지!\n대장장이 철수에게서 칼을 단련하고 구름 위 대산맥과 슬라임 숲을 정복해보게나!",
        chatLines: ["50마리 군단을 마주하는 용사의 패기!", "민우야, 절벽 근처 슬라임은 조심하렴!", "대장장이 철수 칼솜씨는 여전히 최고야."],
