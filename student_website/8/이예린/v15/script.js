// -------------------------------------------------------------
// 3D 1인칭 용사의 모험 RPG v15 Engine (레벨업 체력 풀회복 초기화)
// -------------------------------------------------------------
...
// 💖 [핵심 요청 구현] 레벨업 시 최대 체력 +50 상승 & 깎인 체력 100% 풀회복 초기화!
function gainExp(amount) {
    ...
    while (exp >= targetExp) {
        ...
        maxHp += 50;
        hp = maxHp; // 💖 체력을 최대치로 깨끗하게 풀회복 초기화!

        swordDamage += 1;
        playCustomSound('yap');
        showLevelUpToast(`🎉 LEVEL UP! Lv.${level} 달성! (최대 체력 +50 & 피 풀회복 초기화 완료!)`);
    }
