// -------------------------------------------------------------
// 3D 1인칭 용사의 모험 RPG v21 Engine
// (반짝이는 눈동자 & 디테일 3D 캐릭터 / 몬스터 모델링 전면 탑재)
// -------------------------------------------------------------
...
// 마을 주민 NPC들 (👀 초롱초롱한 눈동자 + 모자/두건/팔 모델링 추가!)
const npcsVillage = [
    { 
        id: 'villager0', 
        name: '이장님 성민', 
        ...
        color: 0xf39c12, 
        hatColor: 0xd35400,
        story: "허허, 어서오게 젊은 용사여!\n레벨이 올라가면 몬스터들의 공격력도 +10씩 매섭게 강해진다네!\n숲으로 떠나기 전에 대장간에서 칼을 단련하고 단단히 대비하게나!",
    ...
    { 
        ...
        color: 0xe74c3c, 
        hatColor: 0xc0392b,
        story: "와! 멋진 용사 형이다!\n몬스터들이 눈을 부라리며 숲속을 살아서 뛰어다니고 레벨업하면 더 세진대요!\n조심해서 다녀오세요!",
    ...
    { 
        ...
        color: 0x9b59b6, 
        hatColor: 0x8e44ad,
        story: "넓은 숲속 몬스터들을 소탕해주시면 예쁜 꽃밭을 가꿀 수 있답니다!",
    ...
    { 
        ...
        color: 0x3498db, 
        hatColor: 0x2980b9,
        story: "전설의 모험가 한스라네!\n몬스터들의 매서운 +10 공격력 속에서도 굴하지 않고 레벨 3에 도달해보게나!",
...
// -------------------------------------------------------------
// 👾 살아 숨쉬는 3D 몬스터 모델링 빌더 (👀 눈동자 + 뿔 + 귀 + 다리)
// -------------------------------------------------------------
...
// -------------------------------------------------------------
// 👾 살아서 움직이는 몬스터 AI & [핵심 요청] 레벨당 공격력 +10 상승!
// -------------------------------------------------------------
