...
class CatHealingGame {
  ...
  goToDressRoom() {
    ...
    this.extraMenu.classList.add('hidden');
    // Position cat prominently right in the center of the mirror area!
    this.catX = 425;
    this.catY = 260;
  }
  ...
  // --- Dress Room Scene (Centered Big Fitting Mirror Area) ---
  ...
  drawMainCat() {
    ...
    // Slightly larger scale in dress room so clothing is extra clear!
