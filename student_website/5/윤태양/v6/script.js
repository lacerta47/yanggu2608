...
// 공룡 그리기 (무적 우유 3초 남으면 몸에 3, 2, 1 카운트다운 숫자가 새겨집니다!)
function drawDino() {
    ...
    // 🥛★ 핵심 기능: 무적 우유 시간이 3초(180프레임) 남았을 때 공룡 몸 위에 3, 2, 1 카운트다운 숫자를 새김!
    if (isMilkActive && milkTimer <= 180) {
        const remainingSeconds = Math.ceil(milkTimer / 60); // 3, 2, 1
