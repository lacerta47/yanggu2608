// 픽셀 RPG v5 게임 엔진: 맵별 고유 테마 분위기 (평화로운 마을, 습한 늪, 신비로운 숲, 광물 빛 동굴)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function draw() {
        ...
        if (currentZone === 'TOWN') {
            ...
            ctx.fillStyle = '#16281e'; // 어두운 진흙 늪지
            ctx.fillRect(0, 0, canvas.width, canvas.height);

            // 축축한 늪 웅덩이들 (물이 고인 어두운 연못)
            ...
            ctx.fillStyle = '#0d261a'; // 깊은 에메랄드 숲
            ctx.fillRect(0, 0, canvas.width, canvas.height);
            ...
            ctx.fillStyle = '#120f1c'; // 어두운 흑요석 동굴
            ctx.fillRect(0, 0, canvas.width, canvas.height);
