...
// 5. Realistic Multi-Tone Biome Theme Sets & Checkpoint Color Specifications
...
const biomeThemes = {
    1: {
        ...
        cpPlat: 0x0369a1, cpPillar: 0x38bdf8, cpEmissive: 0x0284c7, // Theme-matched Checkpoint (Ocean Cyan)
    ...
    2: {
        ...
        cpPlat: 0x991b1b, cpPillar: 0xef4444, cpEmissive: 0xd97706, // Theme-matched Checkpoint (Fiery Crimson)
    ...
    3: {
        ...
        cpPlat: 0x581c87, cpPillar: 0xc084fc, cpEmissive: 0x9333ea, // Theme-matched Checkpoint (Cosmic Magenta)
    ...
    4: {
        ...
        cpPlat: 0x065f46, cpPillar: 0x34d399, cpEmissive: 0x059669, // Theme-matched Checkpoint (Aurora Emerald)
    ...
    5: {
        ...
        cpPlat: 0x854d0e, cpPillar: 0xfacc15, cpEmissive: 0xd97706, // Theme-matched Checkpoint (Radiant Gold)
    ...
    special: {
        ...
        cpPlat: 0x9f1239, cpPillar: 0xf43f5e, cpEmissive: 0xe11d48, // Theme-matched Checkpoint (Rainbow Neon)
...
// 8. Level Builder with Theme-Matched Checkpoint Platform Colors!
...
// Theme-Matched Checkpoint Platform Creator!
...
function loadSpecialStage() {
    ...
    createPlatform(0, 2, -22, 7, 2, 7, theme);
    createBoosterPad(0, 2, -22);

    createCheckpointPlatform(0, 12, -48, theme);

    createWall(-7, 16, -68, 1, 16, 24, theme);
    createWall(7, 20, -92, 1, 16, 24, theme);

    createPlatform(0, 22, -114, 7, 2, 7, theme);
    createBoosterPad(0, 22, -114);

    createCheckpointPlatform(0, 28, -140, theme);

    createWall(-8, 32, -162, 1, 16, 24, theme);
    createPlatform(0, 34, -184, 7, 2, 7, theme);
    createBoosterPad(0, 34, -184);

    createPlatform(0, 42, -210, 7, 2, 7, theme);
    createBoosterPad(0, 42, -210);
    
    createCheckpointPlatform(0, 48, -236, theme);

    createWall(8, 52, -260, 1, 16, 24, theme);
    createPlatform(0, 56, -284, 10, 2, 10, theme);
    createBoosterPad(0, 56, -284);
    createGoal(0, 60, -308);
