...
// REALISTIC SCI-FI DUAL-LAYER GLOWING LASER EMITTER POD!
function createLaser(x, y, z, width = 7, moveRange = 3.5, speed = 2.0) {
    const laserGroup = new THREE.Group();

    // 1. Inner Super Hot Plasma White Core Beam
    ...
    // 2. Outer Transparent Glowing Red Sheath Sheen
    ...
    // 3. Metallic Emitter Cannon Pods on Both Ends
    ...
    // 4. Glowing Red Warning Energy Ring Caps on Emitters
