...
// 👑 PURE INVISIBLE ADMIN SECRET SHORTCUT CHEAT WARP (ONLY SHIFT + P!) 👑
...
// Keyboard Event Handlers (ONLY Shift + P FOR SOLE SECRET CHEAT KEY!)
document.addEventListener('keydown', (e) => {
    if (gameState !== 'playing') return;

    // 👑 ONLY Shift + P FOR SECRET CHEAT KEY TRIGGER!
