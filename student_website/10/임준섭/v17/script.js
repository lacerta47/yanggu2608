...
function updateClosetUI() {
    ...
    thunderStatusTag.textContent = isThunderUnlocked ? '✅ 해금 완료! (화염 이펙트)' : '🔒 5단계 클리어 시 해금 (화염 이펙트)';
    ...
    emeraldStatusTag.textContent = isEmeraldUnlocked ? '✅ 해금 완료! (나뭇잎 이펙트)' : '🔒 10단계 클리어 시 해금 (나뭇잎 이펙트)';
    ...
    diamondStatusTag.textContent = isDiamondUnlocked ? '✅ 해금 완료! (얼음 이펙트)' : '🔒 15단계 클리어 시 해금 (얼음 이펙트)';
...
// 13. Main Game Loop (Pure 1st Person FPS Parkour)
